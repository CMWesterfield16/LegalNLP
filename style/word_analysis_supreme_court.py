...
inputdir = "./../_data/"
outputfile = "summary_results_supreme_court.txt"
...
def word_analysis(judge, typ, case, outputfile, latinTerms, decisiveTerms):
	...
	with open("./../_data/supreme_court/" + judge + "/" + typ + "/" + case, "rb") as casef:
		print( "./../_data/supreme_court/" + judge + "/" + typ + "/" + case)
...
def main():
	...
	for judge in os.listdir("./../_data/supreme_court/"):
		specialoutputfile = "./output_by_judge/" + judge + ".txt"
		with open(specialoutputfile, "w+") as f:
			f.write("Judge\tType\tCase\t" + "\t".join(parameters) + "\n")

		for typ in os.listdir("./../_data/supreme_court/" + judge):
			list_of_lists = []
			for case in os.listdir("./../_data/supreme_court/" + judge + "/" + typ):
